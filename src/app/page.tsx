...
export default async function Home() {
  const [trendingArtworks, featuredArtists] = await Promise.all([
    getArtworks(6),
          ...
          <div className="flex flex-col items-start justify-between gap-4 md:flex-row md:items-center mb-8">
            <div>
              ...
              <p className="text-muted-foreground">
                Explore the latest artwork trending on Draint
              </p>
            </div>
        ...
        <div className="container px-4 md:px-6">
          <div className="flex flex-col items-start justify-between gap-4 md:flex-row md:items-center mb-8">
            <div>
              ...
              <p className="text-muted-foreground">
                Discover amazing creators and their work
              </p>
            </div>
            <Button asChild variant="outline">
            ...
            {[
              {
                title: "Create & Upload",
                description:
                  "Create your artwork and upload it to your portfolio",
              },
              {
                title: "List & Sell",
          ...
          <div className="grid gap-6 lg:grid-cols-2 lg:gap-12 items-center">
            <div className="order-2 lg:order-1">
              <h2 className="text-2xl font-bold tracking-tight sm:text-3xl mb-4">
                Art with Environmental Impact
              </h2>
              <p className="mb-4">
                We believe in sustainable art. That&#39;s why Draint contributes
                1% of every payment to remove CO₂ from the atmosphere.
              </p>
              <p className="mb-6">
                Join us in our mission to support both artists and the
                environment through beautiful digital creations.
              </p>
              <Button asChild>
