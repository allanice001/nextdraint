...
export default async function UploadArtworkPage() {
  ...
  const [categoriesResult, mediumsResult, stylesResult, surfacesResult] =
    await Promise.all([
      getCategories(),
      getMediums(),
      getStyles(),
    ...
    <div className="container py-10">
      <div className="max-w-3xl mx-auto">
        ...
        <p className="text-muted-foreground mb-8">
          ...
          upload your artwork to Draint.
        </p>

        <ArtworkUploadForm
          categories={categoriesResult}
          mediums={
            mediumsResult.success && mediumsResult.mediums
              ? mediumsResult.mediums
              : []
          }
          styles={
            stylesResult.success && stylesResult.styles
              ? stylesResult.styles
              : []
          }
          surfaces={
            surfacesResult.success && surfacesResult.surfaces
              ? surfacesResult.surfaces
              : []
          }
        />
      </div>
