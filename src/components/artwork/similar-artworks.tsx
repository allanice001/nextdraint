...
export function SimilarArtworks({ artworks, title = "You might also like" }: SimilarArtworksProps) {
						...
						<Card key={artwork.id} className="min-w-[250px] overflow-hidden">
							...
							<CardContent className="p-3">
								<div className="flex justify-between items-center">
									...
									<span className="text-sm font-medium">{formatPrice(artwork.price.toString(), artwork.currency)}</span>
								</div>
							</CardContent>
						</Card>
					))}
