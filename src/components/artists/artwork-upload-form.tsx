...
export function ArtworkUploadForm({ categories, mediums, styles, surfaces }: ArtworkUploadFormProps) {
				...
				<div className="grid grid-cols-1 md:grid-cols-2 gap-8">
							...
							<CardContent className="p-6">
								<div className="mb-4">
									...
									<p className="text-sm text-muted-foreground mb-4">
										Upload a high-quality image of your artwork. Supported formats: JPEG, PNG, WebP, GIF.
									</p>
								</div>
							...
							<CardContent className="p-6">
								<div className="mb-4">
									...
									<p className="text-sm text-muted-foreground">
										Provide information about your artwork to help collectors find and understand your piece.
									</p>
								</div>
					...
					<div className="space-y-6">
						<Card>
							<CardContent className="p-6">
								<div className="mb-4">
									...
									<p className="text-sm text-muted-foreground">Set the price for your artwork.</p>
								</div>
						...
						<Card>
							<CardContent className="p-6">
								<div className="mb-4">
									<h3 className="text-lg font-medium mb-2">Artwork Specifications</h3>
									<p className="text-sm text-muted-foreground">
										Provide details about the medium, style, and physical characteristics of your artwork.
									</p>
								</div>
										...
										<FormField
											...
											render={({ field }) => (
												<FormItem>
													...
													<FormControl>
														<Input type="number" min="0" placeholder="Thickness" {...field} />
													</FormControl>
													<FormMessage />
												</FormItem>
											)}
						...
						<Card>
							<CardContent className="p-6">
								<div className="mb-4">
									...
									<p className="text-sm text-muted-foreground">
										Select categories that best describe your artwork to help collectors find it.
									</p>
								</div>
