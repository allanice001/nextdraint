			...
			<div className="container px-4 md:px-6 py-12">
				<div className="grid grid-cols-1 gap-8 sm:grid-cols-2 md:grid-cols-4 lg:grid-cols-5">
					<div className="flex flex-col space-y-4">
						...
						<div className="flex flex-col space-y-2">
							<div className="flex gap-2">
								...
								/>
								<Button className="bg-purple-600 hover:bg-purple-700">News</Button>
							</div>
							<p className="text-xs text-gray-500">Thanks for joining our Newsletter!</p>
						</div>
						...
						<div className="flex items-center space-x-2 mt-4">
							<div className="h-12 w-12 rounded-full overflow-hidden border border-gray-200">
								<svg viewBox="0 0 24 24" fill="none" className="h-full w-full p-2">
									<path
							...
							<div className="text-sm">
								<p className="font-medium">Draint will contribute <span className="font-bold">1% of your Payment</span> to remove CO₂ from the Atmosphere.</p>
							</div>
						</div>
					</div>
					...
					<div className="flex flex-col space-y-4">
						...
						<Link href="/why-draint" className="text-gray-600 hover:text-purple-600 transition-colors">
							Why Draint
						</Link>
					...
					<div className="flex flex-col space-y-4">
						...
						<Link href="/trade" className="text-gray-600 hover:text-purple-600 transition-colors">
							Trade your Paintings
						</Link>
						<Link href="/signup" className="text-gray-600 hover:text-purple-600 transition-colors">
							SignUp
						</Link>
						<Link href="/search-artists" className="text-gray-600 hover:text-purple-600 transition-colors">
							Search for Artists
						</Link>
						<Link href="/search-paintings" className="text-gray-600 hover:text-purple-600 transition-colors">
					...
					<div className="flex flex-col space-y-4">
						...
						<Link href="/imprint" className="text-gray-600 hover:text-purple-600 transition-colors">
							Imprint
						</Link>
						<Link href="/legals" className="text-gray-600 hover:text-purple-600 transition-colors">
							Legals
						</Link>
					</div>
				</div>
